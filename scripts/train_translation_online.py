"""
# no dapg
python skilltranslation/scripts/train_translation_online.py skilltranslation/cfgs/boxpusher_translation_online.yml
python skilltranslation/scripts/train_translation_online.py \
    env=BoxPusherTrajectory-v0 \
    env_cfg.trajectories=datasets/data_v1_new/clean_learned_train_ids.npy \
    env_cfg.trajectories_dataset=datasets/data_v1_new/clean_learned.npy \
    model_cfg.state_dims=6 model_cfg.act_dims=2 model_cfg.teacher_dims=6 exp_cfg.eval_freq=20 \
    logging_cfg.wandb=False logging_cfg.exp_name=translation/test_online restart_training=True
# with dapg
python skilltranslation/scripts/train_translation_online.py \
    env=BoxPusherTrajectory-v0 \
    exp_cfg.dapg=True \
    exp_cfg.dapg_cfg.trajectories_dataset=datasets/data_v1_new/clean_learned.npy \
    env_cfg.trajectories=datasets/data_v1_new/clean_learned_train_ids.npy \
    model_cfg.state_dims=6 model_cfg.act_dims=2 model_cfg.teacher_dims=6 exp_cfg.eval_freq=20 \
    logging_cfg.wandb=False logging_cfg.exp_name=translation/test_online
"""
