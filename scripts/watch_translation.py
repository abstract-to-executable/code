"""
python skilltranslation/scripts/watch_translation.py \
    cfg=skilltranslation/cfgs/boxpusher/watch_translation.yml \
    model=test.pt traj_id=1

python skilltranslation/scripts/watch_translation.py \
    cfg=skilltranslation/cfgs/carlane/watch_translation.yml \
    model=test.pt traj_id=1
python skilltranslation/scripts/watch_translation.py \
    cfg=skilltranslation/cfgs/lunarlander/watch_translation.yml \
    model=results/lunarlander/mlp/models/latest.pt traj_id=1 env_cfg.give_traj_id=True
"""
