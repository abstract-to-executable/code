"""
python skilltranslation/scripts/train_translation_bc.py \
    dataset=datasets/data_v1_new/clean_learned.npy train_ids=datasets/data_v1_new/clean_learned_train_ids.npy \
    val_ids=datasets/data_v1_new/clean_learned_val_ids.npy model_cfg.state_dims=6 model_cfg.act_dims=2 model_cfg.teacher_dims=6

python skilltranslation/scripts/train_translation_bc.py \
    dataset=datasets/boxpusher_v1/dataset.pkl train_ids=datasets/boxpusher_v1/dataset_train_ids.npy \
    val_ids=datasets/boxpusher_v1/dataset_val_ids.npy \
    model_cfg.state_dims=4 model_cfg.teacher_dims=4 model_cfg.act_dims=2

python scripts/train_translation_bc.py \
    cfg=skilltranslation/cfgs/carlane/train_translation_bc.yml \
    dataset=datasets/carlane/v2/tsection.pkl train_ids=datasets/carlane/v2/tsection_train_ids.npy \
    val_ids=datasets/carlane/v2/tsection_val_ids.npy \
    model_cfg.state_dims=3 model_cfg.teacher_dims=2 model_cfg.act_dims=2
"""
