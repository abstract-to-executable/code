...
class LinearEncoderNet(SelfSupervisedModel):
  """A MLP backbone with a linear encoder head."""

  def __init__(self, state_dims, embedding_size, *args, **kwargs):
    ...
    # Encoder.
    self.encoder = nn.Linear(128, embedding_size)
