"""
code adapted from Decision Transformers: TODO CITE
...
from skilltranslation.models.encoders.blockstack_cnn import BlockStackCNNEncoder
from skilltranslation.models.encoders.cnn import CNNEncoder
from skilltranslation.models.encoders.pointnet import PointNetEncoder
...
class TranslationTransformerGPT2(TranslationPolicy):
    ...
    def __init__(
        ...
        **kwargs
        ...
        elif self.encoder_type == "blockstack_cnn":
            self.obs_encoder = BlockStackCNNEncoder(
                **encoder_config
            )
        elif self.encoder_type == "pointnet":
            self.obs_encoder = PointNetEncoder(
                **encoder_config
            )
